...
import RecommandChannelItem from "./components/RecommandChannelItem";
import RecommandContentsItem from "./components/RecommandContentsItem";
            ...
            <div style={{ height: "100vh", display: "flex", flexDirection: "column" }}>
                ...
                <div className="container">
                    ...
                    <div className="recommended_contents">
                        <span style={{ fontSize: 20, fontWeight: "bold", letterSpacing: -0.7 }}>추천 컨텐츠</span>
                    </div>
                    <div className="tagBtn">
                    ...
                    <div className="recommended_contents_container">
                        {pTag === "all" && (
                            <>
                    ...
                    <div className="New_Channel">
                        <span style={{ fontSize: 20, fontWeight: "bold", letterSpacing: -0.7 }}>
                            새로 나온 채널을 확인해 보세요!<span style={{ color: "red", marginLeft: 5, fontWeight: "600", fontStyle: "italic" }}>NEW</span>
                        </span>
                ...
                <style jsx>
                    {`
                        ...
                        .recommended_contents_container {
                            display: flex;
                            flex-direction: row;
                            margin-top: 30px;
                        }
